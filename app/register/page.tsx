              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 hover-zoom bg-input/50 border-border/50 focus:border-accent"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    className="pl-10 pr-10 hover-zoom bg-input/50 border-border/50 focus:border-accent"
                    required
                  />
                  <button
                    type="button"
